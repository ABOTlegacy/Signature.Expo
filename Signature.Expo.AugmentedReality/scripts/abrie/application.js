...
requirejs( ['webcam','ardetector','arview','arobject'], function(webcam,ardetector,arview,arobject) {
    ...
    var markerObjects = {
        1: arobject.createMarkerObject({ name: "1", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #1
        ...
        7: arobject.createMarkerObject({ name: "7", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #7
        8: arobject.createMarkerObject({ name: "8", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #8
        9: arobject.createMarkerObject({ name: "9", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #9
        10: arobject.createMarkerObject({ name: "10", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #10
        11: arobject.createMarkerObject({ name: "11", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #11
        12: arobject.createMarkerObject({ name: "12", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #12
        13: arobject.createMarkerObject({ name: "13", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #13
        14: arobject.createMarkerObject({ name: "14", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #14
        15: arobject.createMarkerObject({ name: "15", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #15
        16: arobject.createMarkerObject({ name: "16", type: "plane", texture: "textures/sand03.jpg", width: 200, height: 200 }), // Marker #16, red.
        17: arobject.createMarkerObject({ name: "17", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #17
        18: arobject.createMarkerObject({ name: "18", color: 0x00BB00, type: "cube", width: 200, height: 200 }), // Marker #18
